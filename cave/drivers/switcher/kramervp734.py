...
class KramerVP734(SwitcherInterface):
    ...
    def power_off(self):
        try:
            ...
            logger.error('power_off(): Exception occurred: {}'.format(e.args), exc_info=True)
            raise e
        finally:
            self.close_connection()
    ...
    def get_power_status(self):
        try:
            ...
            logger.error('get_power_status(): Exception occurred: {}'.format(e.args), exc_info=True)
            raise e
        finally:
            self.close_connection()
    ...
    def get_av_mute(self):
        try:
            ...
            logger.error('get_av_mute(): Exception occurred: {}'.format(e.args), exc_info=True)
            raise e
        finally:
            self.close_connection()
